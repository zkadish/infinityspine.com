...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/fetch */ \"./src/js/utils/fetch.js\");\n/* harmony import */ var _utils_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/html */ \"./src/js/utils/html.js\");\n\n\nconsole.log('patient forms loaded');\nvar pageCopy = document.querySelector('.page-copy'); // New Patient Forms\n\nfetch('https://wp.infinityspine.com/wp-json/wp/v2/pages/2575').then(_utils_fetch__WEBPACK_IMPORTED_MODULE_0__[\"default\"]).then(function (response) {\n  return response.json();\n}).then(function (res) {\n  var frag = Object(_utils_html__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(res.content.rendered);\n  pageCopy.appendChild(frag);\n}).then(function () {\n  pageCopy.classList.add('fade-in');\n})[\"catch\"](function (err) {\n  console.error(err);\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/js/patient-forms.js\n");
